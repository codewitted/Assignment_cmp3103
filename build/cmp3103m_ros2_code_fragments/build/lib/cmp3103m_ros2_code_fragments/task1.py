...
class ColourChaser(Node):
    ...
    def camera_callback(self, data):
        ...
        # ---------------------------------------------------------
        # OBJECT MASK (ANYTHING NOT RED AND NOT FLOOR)
        # ---------------------------------------------------------
        ...
        if self.push_to_edge:
            ...
            # Detect if red border is no longer visible at bottom
        ...
        if len(red_contours) > 0:
            ...
            # Extract only objects INSIDE the arena
        ...
        # ---------------------------------------------------------
        # OBJECT LOST → START PUSH TO EDGE
        # ---------------------------------------------------------
        if not target_found:
