...
setup(
    ...
    zip_safe=True,
    maintainer='Jonathan Cox',
    maintainer_email='jcox289@gmail.com',
    description='CMP3103 example code',
    license='MIT',
    ...
    entry_points={
        'console_scripts': [
            ...
            'task3 = cmp3103m_ros2_code_fragments.task3:main',
            'task2 = cmp3103m_ros2_code_fragments.task2:main',
            'task1 = cmp3103m_ros2_code_fragments.task1:main',
        ],
    },
)
